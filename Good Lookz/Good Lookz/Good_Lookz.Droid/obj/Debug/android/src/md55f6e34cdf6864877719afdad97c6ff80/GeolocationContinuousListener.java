package md55f6e34cdf6864877719afdad97c6ff80;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.0.0.55, Culture=neutral, PublicKeyToken=null", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener () throws java.lang.Throwable
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.0.0.55, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
